...
> `docs/revision/SPLIT_DEFINITION_AND_UNIFIED_RESULTS.md`,
> `docs/revision/why_new_numbers_higher_reviewer_explanation.md`, and
> `docs/revision/reviewer_clarity_summary.md`. Where this checklist disagrees, those win.
...
- `figures/message_selection_gain.png`
- `figures/message_selection_methods_k7.csv`
...
- `figures/class_distribution.csv`
