...
- Source checked: [docs/revision/amiajnl-2026-019201_Proof_hi.pdf](amiajnl-2026-019201_Proof_hi.pdf).
...
- Prompt templates: [../docs/prompt_templates.md](../docs/prompt_templates.md)
- Evaluation code: [../analysis/legacy/main_eval.py](../analysis/legacy/main_eval.py)
- Pipeline scripts call `main_eval.py` with `--mode text-only`:
  [.scripts/legacy/run_full_manuscript_pipeline.sh](.scripts/legacy/run_full_manuscript_pipeline.sh),
