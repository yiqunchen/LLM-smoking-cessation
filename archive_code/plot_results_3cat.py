...
def plot_results(input_file, output_dir=None):
    ...
    # Define label mappings for collapsing categories
    collapse_map = {
        "Very poor": "Poor",
        "Poor": "Poor",
    ...
    # Define 3-category labels for content/design
    dimensions = {
        'content': ["Poor", "Acceptable", "Good"],
        'design': ["Poor", "Acceptable", "Good"],
        'coping': ["Not helpful", "Moderately helpful", "Helpful"],
        'quitting': ["Not helpful", "Moderately helpful", "Helpful"]
    }
    ...
    for dim, labels in dimensions.items():
        ...
        # Apply category collapsing only for content and design
        if dim in ["content", "design", "coping", "quitting"]:
            filtered_df[true_col] = filtered_df[true_col].map(collapse_map)
            filtered_df[pred_col] = filtered_df[pred_col].map(collapse_map)
