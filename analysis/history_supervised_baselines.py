...
Outputs:
  - figures/history_supervised_baselines.csv
  - figures/history_supervised_best_summary.csv
  - figures/history_supervised_best.png/pdf

Usage:
  uv run python analysis/history_supervised_baselines.py
  uv run python analysis/history_supervised_baselines.py --plot-only
"""
