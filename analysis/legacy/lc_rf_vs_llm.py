...
Outputs:
    figures/lc_rf_vs_llm.csv            -- long-form metrics
    figures/lc_rf_vs_llm_predictions.csv -- per-row RF predictions

Usage:
    uv run python analysis/legacy/lc_rf_vs_llm.py
"""
...
def _train_n_for_split(split: str) -> int:
    path = os.path.join(
        PROJECT_ROOT, "data/splits", "canonical",
