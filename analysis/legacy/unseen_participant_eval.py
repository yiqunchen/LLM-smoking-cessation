...
Outputs:
    figures/unseen_participant/metrics.{md,csv}
    figures/unseen_participant/per_row.csv
"""
...
TRAIN_P = PROJECT_ROOT / "data/splits" / "canonical" / "train_participant_3070.json"
TEST_P  = PROJECT_ROOT / "data/splits" / "canonical" / "test_participant_3070.json"

LLM_MODELS = {
    "GPT-4o-mini":     PROJECT_ROOT / "results/manuscript/gpt-4o-mini",
    "GPT-5":           PROJECT_ROOT / "results/manuscript/gpt-5",
    "Gemini-2.5-Pro":  PROJECT_ROOT / "results/manuscript/gemini-2.5-pro",
    "Grok-4-Fast":     PROJECT_ROOT / "results/manuscript/x-ai_grok-4-fast",
    "DeepSeek-R1":     PROJECT_ROOT / "results/manuscript/deepseek_deepseek-r1-0528",
}
