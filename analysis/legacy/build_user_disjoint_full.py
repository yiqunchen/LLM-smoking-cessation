...
Outputs
-------
    data/splits/canonical/train_user_disjoint_3070_full.json
    data/splits/canonical/test_user_disjoint_3070_full.json
    data/splits/canonical/train_user_disjoint_1090_full.json
    data/splits/canonical/test_user_disjoint_1090_full.json

Usage:
    uv run python analysis/legacy/build_user_disjoint_full.py
"""
...
CANONICAL = PROJECT_ROOT / "data/splits" / "canonical"
