...
async def main():
    ...
    parser.add_argument('--train-file', type=str, default=None, help="(Digital-twin) Path to TRAIN split for building participant profiles (e.g., data/splits/canonical/train_digital_twin_5050.json)")
    ...
    if args.adaptive:
        ...
        cmd = [
            sys.executable, 
            "analysis/run_adaptive_optimization.py",
            "--model", args.model,
            "--mode", args.mode,
