...
computes metrics with bootstrap 95% CIs, and produces:
  ...
  - figures/cbt_vs_act_performance.png/pdf

Usage:
    uv run python analysis/legacy/cbt_act_comparison.py
    uv run python analysis/legacy/cbt_act_comparison.py --plot-only
    uv run python analysis/legacy/cbt_act_comparison.py --models gpt-5 \
