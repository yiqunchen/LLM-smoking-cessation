...
Outputs:
  - figures/bars_all_methods_<metric>.csv
  - figures/bars_all_methods_<metric>.png/.pdf
  - figures/all_methods_global_common_subset_results.csv
  - figures/all_methods_global_common_subset_coverage.csv
  - figures/all_methods_global_baseline_subset.csv
  - figures/all_methods_global_baseline_best.csv

Usage:
  uv run python analysis/legacy/qwk_method_comparison.py
  uv run python analysis/legacy/qwk_method_comparison.py --plot-only
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--plot-only",
        action="store_true",
        help="Reload saved figures common-subset CSVs and regenerate bars only.",
    )
