...
Metrics → tables:
    T1: Accuracy             figures/lc_three_methods_t1_accuracy.{md,csv}
    T2: Macro-F1             figures/lc_three_methods_t2_f1.{md,csv}
    T3: QWK + Kappa          figures/lc_three_methods_t3_qwk_kappa.{md,csv}

Usage:
    uv run python analysis/legacy/lc_three_method_tables.py
"""
...
LLM_DIRS = {
    "GPT-4o-mini":     "results/manuscript/gpt-4o-mini",
    "GPT-5":           "results/manuscript/gpt-5",
    "Gemini-2.5-Pro":  "results/manuscript/gemini-2.5-pro",
    "Grok-4-Fast":     "results/manuscript/x-ai_grok-4-fast",
    "DeepSeek-R1":     "results/manuscript/deepseek_deepseek-r1-0528",
}
GENERIC_FILES = {
...
def _split_train_stats(split: str) -> tuple[int, int, float]:
    ...
    base = os.path.join(PROJECT_ROOT, "data/splits", "canonical")
...
def render_metric_table(df: pd.DataFrame, metric_keys: list[str],
    ...
    out.append(
        ...
        "- Source CSVs: `figures/lc_rf_vs_llm.csv`, "
