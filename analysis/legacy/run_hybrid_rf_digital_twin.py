...
def train_rf_on_all_features():
    ...
    with open('data/splits/canonical/train_participant_7030.json') as f:
        train_data = json.load(f)
    with open('data/splits/canonical/test_participant_7030.json') as f:
    ...
    output_dir = 'results/manuscript/hybrid_rf_grok4'
...
def main():
    ...
    print("1. RF predictions saved to results/manuscript/hybrid_rf_grok4/")
