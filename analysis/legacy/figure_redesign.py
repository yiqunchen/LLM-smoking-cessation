...
Outputs:
  - figures/figure_redesign_results.csv
  - figures/bars_generic_methods_<metric>.png/.pdf
  - figures/bars_personalized_methods_<metric>.png/.pdf
  - figures/figure3_score_distributions_<domain>.png/.pdf
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--plot-only",
        action="store_true",
        help="Reload saved figures source CSVs and regenerate PNG/PDF outputs only.",
    )
