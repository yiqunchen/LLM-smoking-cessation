...
Outputs:
  - figures/gemini_history_only_metric_comparison.csv
  - figures/gemini_history_only_metric_comparison.png/pdf

Usage:
  uv run python analysis/legacy/gemini_history_only_metric_plot.py
"""
...
MODEL_DIR = Path("results/manuscript/gemini-2.5-pro")
