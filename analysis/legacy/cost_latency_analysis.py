...
- figures/cost_per_participant.png / .pdf

Usage
-----
    uv run python analysis/legacy/cost_latency_analysis.py
"""
...
def _find_hybrid_sample(digital_test):
    ...
    rf_pred_path = os.path.join(
        PROJECT_ROOT,
        "results/manuscript/hybrid_rf_grok4",
...
def main():
    ...
    # ---- Save CSV ----
    csv_path = os.path.join(PROJECT_ROOT, "figures", "cost_latency_analysis.csv")
