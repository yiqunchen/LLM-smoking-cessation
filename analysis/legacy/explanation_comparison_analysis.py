...
Outputs:
  - figures/explanation_pairwise_comparison.csv
  - figures/explanation_pairwise_summary.csv
  - figures/explanation_keyword_summary.csv
  - figures/explanation_pair_examples.csv
  - figures/explanation_comparison_report.md

Usage:
  uv run python analysis/legacy/explanation_comparison_analysis.py
"""
