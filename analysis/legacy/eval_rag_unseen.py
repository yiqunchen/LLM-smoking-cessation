...
Inputs
------
  results/manuscript/x-ai_grok-4-fast/rag_unseen_p3070_k3.json
  results/manuscript/x-ai_grok-4-fast/generic_llm_1_zero_shot.json   (Grok zero-shot)
  data/splits/canonical/{train,test}_participant_3070.json           (RF train/eval)

Output
------
  figures/unseen_participant/rag_vs_zero_shot.{md,csv}
"""
