...
Outputs:
    figures/lc_full_methods.csv
    figures/lc_full_methods_t1_accuracy.md
    figures/lc_full_methods_t2_f1.md
    figures/lc_full_methods_t3_qwk_kappa.md

Usage:
    uv run python analysis/legacy/lc_full_method_tables.py
"""
...
def render_table(df_long: pd.DataFrame, metric_keys: list[str],
    ...
    out.append(
        ...
        f"- Source CSVs: `figures/lc_rf_vs_llm.csv`, "
