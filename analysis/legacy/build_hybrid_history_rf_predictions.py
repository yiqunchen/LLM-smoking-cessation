...
Output JSON has the same shape as the original
  results/manuscript/hybrid_rf_grok4/rf_predictions_all_features.json
...
Saves to: results/manuscript/hybrid_rf_history/rf_predictions_history_features.json
"""
...
RANDOM_STATE = 42
OUTPUT_DIR = os.path.join(BASE, "results/manuscript/hybrid_rf_history")
