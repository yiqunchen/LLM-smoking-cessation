...
def load_rf_predictions():
    ...
    rf_path = "results/manuscript/hybrid_rf_grok4/rf_predictions_all_features.json"
...
def run_supervised_baselines(data_path: str = 'data/splits/canonical'):
...
def create_hybrid_vs_rf_confusion_matrix(output_dir: str):
    ...
    hybrid_file = "results/manuscript/hybrid_x-ai_grok-4-fast/evaluation_results_x-ai_grok-4-fast_text-only_hybrid-rf-digital-twin.json"
...
def create_predicted_vs_true_distributions(output_dir: str):
    ...
    MODEL_CONFIGS_PRED = {
        'gpt-4o-mini': {'dir': 'results/manuscript/gpt-4o-mini', 'hybrid_dir': 'results/manuscript/hybrid_gpt-4o-mini', 'hybrid_file': 'evaluation_results_gpt-4o-mini_text-only_hybrid-rf-digital-twin.json'},
        'gpt-5': {'dir': 'results/manuscript/gpt-5', 'hybrid_dir': 'results/manuscript/hybrid_gpt-5', 'hybrid_file': 'evaluation_results_gpt-5_text-only_hybrid-rf-digital-twin.json'},
        'deepseek_deepseek-r1-0528': {'dir': 'results/manuscript/deepseek_deepseek-r1-0528', 'hybrid_dir': 'results/manuscript/hybrid_deepseek_deepseek-r1-0528', 'hybrid_file': 'evaluation_results_deepseek_deepseek-r1-0528_text-only_hybrid-rf-digital-twin.json'},
        'x-ai_grok-4-fast': {'dir': 'results/manuscript/x-ai_grok-4-fast', 'hybrid_dir': 'results/manuscript/hybrid_x-ai_grok-4-fast', 'hybrid_file': 'evaluation_results_x-ai_grok-4-fast_text-only_hybrid-rf-digital-twin.json'},
        'gemini-2.5-pro': {'dir': 'results/manuscript/gemini-2.5-pro', 'hybrid_dir': 'results/manuscript/hybrid_gemini-2.5-pro', 'hybrid_file': 'evaluation_results_gemini-2.5-pro_text-only_hybrid-rf-digital-twin.json'}
    }
