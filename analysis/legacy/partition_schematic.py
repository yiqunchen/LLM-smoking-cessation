...
Two-panel figure intended for the manuscript revision:
  ...
  Panel A (top, schematic):
    ...
    - Leakage audit bullets pulled from `figures/label_leakage_analysis.csv`
...
Outputs:
  ...
  figures/partition_schematic.pdf
  figures/apples_to_apples_result.png
  figures/apples_to_apples_result.pdf

Run:
  uv run python analysis/legacy/partition_schematic.py
"""
...
def draw_schematic():
    ...
    ax.text(0.5, 1.05,
            "Leakage audit  ·  source: figures/label_leakage_analysis.csv",
...
def draw_partition_matrix():
    ...
    import json as _json
    canonical = "/Users/yiqun/Desktop/chen-lab/LLM-smoking-cessation/data/splits/canonical"
