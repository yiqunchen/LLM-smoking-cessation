...
Usage:
    OPENROUTER_API_KEY=... uv run python analysis/legacy/run_zeroshot_grok.py \
        --test-path data/splits/canonical/test_user_disjoint_1090_full.json \
...
def main():
    ...
    p.add_argument("--output-name", required=True,
                    help="filename stem (no extension); written to results/manuscript/x-ai_grok-4-fast/")
