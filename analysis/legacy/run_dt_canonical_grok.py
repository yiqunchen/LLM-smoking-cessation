...
For each split in {1090, 3070, 5050, 7030, 9010}:
  ...
  5. Save predictions to
     ``results/manuscript/x-ai_grok-4-fast/digital_twin_4_cbtact_canonical_{split}.json``.
...
Usage
-----
    OPENROUTER_API_KEY=... uv run python analysis/legacy/run_dt_canonical_grok.py
...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "results/manuscript/x-ai_grok-4-fast")
