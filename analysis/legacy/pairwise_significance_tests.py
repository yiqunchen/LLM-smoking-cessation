...
Outputs:
  ...
  - figures/pairwise_significance_heatmap.png/pdf

Usage:
    uv run python analysis/legacy/pairwise_significance_tests.py
    uv run python analysis/legacy/pairwise_significance_tests.py --plot-only
"""
