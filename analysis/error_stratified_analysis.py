...
Outputs:
  figures/error_stratified/per_row_k3.csv
  figures/error_stratified/by_gt_rating.{md,csv}
  figures/error_stratified/by_quit_intention.{md,csv}
  figures/error_stratified/by_smoking_status.{md,csv}
  figures/error_stratified/by_age_band.{md,csv}
  figures/error_stratified/win_loss_bars.{png,pdf}
  figures/error_stratified/headline.md  (top strata where LLM-PP wins)
"""
...
def load_llm_predictions_and_meta() -> tuple[dict, dict]:
    ...
    path = (PROJECT_ROOT / "results/manuscript/x-ai_grok-4-fast"
