...
MODELS = (
    ("GPT-4o-mini", "results/prompt_ablations/gpt-4o-mini", "openai/gpt-4o-mini"),
    ("GPT-5", "results/prompt_ablations/gpt-5", "openai/gpt-5"),
    ("DeepSeek-R1", "results/prompt_ablations/deepseek-r1", "deepseek/deepseek-r1-0528"),
    ("Grok-4.3", "results/prompt_ablations/grok-4.3", "x-ai/grok-4.3"),
    ("Gemini-2.5-Pro", "results/prompt_ablations/gemini-2.5-pro", "google/gemini-2.5-pro"),
)
