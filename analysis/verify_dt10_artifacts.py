...
PRIMARY_META = ROOT / "data/splits/canonical/metadata_dt10_k7.json"
PRIMARY_TRAIN = ROOT / "data/splits/canonical/train_dt10_k7.json"
PRIMARY_TEST = ROOT / "data/splits/canonical/test_dt10_k7.json"
PUBLISHED_DIRS = [ROOT / "figures", ROOT / "figures"]
...
STRICT_SOURCE = ROOT / "figures/progress_summary/ai_vs_ml_strict_fixed_feature.csv"
