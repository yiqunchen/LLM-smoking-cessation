...
Outputs:
    data/splits/canonical/train_dt10_k{k}.json
    data/splits/canonical/test_dt10_k{k}.json
    data/splits/canonical/metadata_dt10_k{k}.json
...
Usage:
    uv run python analysis/build_dt10_splits.py
"""
...
OUT_DIR = os.path.join(PROJECT_ROOT, "data/splits", "canonical")
