...
CANONICAL_DIR = os.path.join(PROJECT_ROOT, 'data/splits', 'canonical')
...
MODEL_CONFIGS = {
    'gpt-4o-mini': {'dir': 'results/manuscript/gpt-4o-mini', 'display': 'GPT-4o-mini'},
    'gpt-5': {'dir': 'results/manuscript/gpt-5', 'display': 'GPT-5'},
    'deepseek_deepseek-r1-0528': {'dir': 'results/manuscript/deepseek_deepseek-r1-0528', 'display': 'DeepSeek-R1'},
    'x-ai_grok-4-fast': {'dir': 'results/manuscript/x-ai_grok-4-fast', 'display': 'Grok-4-Fast'},
    'gemini-2.5-pro': {'dir': 'results/manuscript/gemini-2.5-pro', 'display': 'Gemini-2.5-Pro'},
}
...
def figures_path(name: str) -> str:
    """Return full path (without extension) for a figure in figures/."""
