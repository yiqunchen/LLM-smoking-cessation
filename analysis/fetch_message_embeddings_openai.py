...
Usage example:
  ...
  python analysis/fetch_message_embeddings_openai.py \
    --input-json data/processed_llm_data.json \
    --output-pkl message_embeddings.pkl \
    --output-csv data/raw/message_embeddings.csv \
...
def main() -> None:
    ...
    parser.add_argument("--output-csv", default="data/raw/message_embeddings.csv")
