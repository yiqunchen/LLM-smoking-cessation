...
Outputs:
  - figures/text_baseline_results.csv
  - figures/all_baselines_comparison.png/pdf
  - figures/baseline_feature_ablation.png/pdf

Usage:
  uv run python analysis/text_baselines.py
"""
...
# ---------------------------------------------------------------------------
RANDOM_STATE = 42
EMBEDDING_PATH = os.path.join(PROJECT_ROOT, 'data', 'raw', 'message_embeddings.pkl')
