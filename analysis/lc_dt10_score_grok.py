...
results/manuscript/x-ai_grok-4-fast/, this script:
  ...
  4. Appends rows to figures/lc_dt10_llmdt.csv with a
...
Usage:
    uv run python analysis/lc_dt10_score_grok.py
"""
...
GROK_DIR = os.path.join(PROJECT_ROOT, "results/manuscript/x-ai_grok-4-fast")
