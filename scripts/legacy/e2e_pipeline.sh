...
#
# Usage:
#   bash scripts/legacy/e2e_pipeline.sh
#
# Requirements:
...
bash scripts/legacy/run_full_manuscript_pipeline.sh gpt-4o-mini openai
echo ""

# Model 2: GPT-5
echo -e "${GREEN}[2/5] Running GPT-5...${NC}"
bash scripts/legacy/run_full_manuscript_pipeline.sh gpt-5 openai
echo ""

# Model 3: DeepSeek-R1
echo -e "${GREEN}[3/5] Running DeepSeek-R1...${NC}"
bash scripts/legacy/run_full_manuscript_pipeline.sh deepseek/deepseek-r1-0528 openrouter
echo ""

# Model 4: Grok-4-Fast
echo -e "${GREEN}[4/5] Running Grok-4-Fast...${NC}"
bash scripts/legacy/run_full_manuscript_pipeline.sh x-ai/grok-4-fast openrouter
echo ""

# Model 5: Gemini 2.5 Pro
echo -e "${GREEN}[5/5] Running Gemini 2.5 Pro...${NC}"
bash scripts/legacy/run_full_manuscript_pipeline.sh gemini-2.5-pro gemini
echo ""
...
echo "  - results/manuscript/gpt-4o-mini/"
echo "  - results/manuscript/gpt-5/"
echo "  - results/manuscript/deepseek_deepseek-r1/"
echo "  - results/manuscript/x-ai_grok-4-fast/"
echo "  - results/manuscript/gemini-2.5-pro/"
echo ""
echo "Each directory contains:"
echo "  • 13 JSON result files (6 Generic LLM + 7 PP configurations)"
