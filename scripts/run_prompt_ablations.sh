...
#
#   bash scripts/run_prompt_ablations.sh            # all five models
#   bash scripts/run_prompt_ablations.sh gpt5 grok  # subset
#   CONCURRENCY=10 bash scripts/run_prompt_ablations.sh
#
...
MODELS=(
  "gpt4o|openai/gpt-4o-mini|results/prompt_ablations/gpt-4o-mini|--max-output-tokens 300"
  "gpt5|openai/gpt-5|results/prompt_ablations/gpt-5|--max-output-tokens 1000 --reasoning-effort low"
  "deep|deepseek/deepseek-r1-0528|results/prompt_ablations/deepseek-r1|--max-output-tokens 2000 --reasoning-effort low"
  "grok|x-ai/grok-4.3|results/prompt_ablations/grok-4.3|--max-output-tokens 300"
  "gemini|google/gemini-2.5-pro|results/prompt_ablations/gemini-2.5-pro|--max-output-tokens 0"
)
