...
def create_grouped_bar_charts(df: pd.DataFrame, output_dir: str):
    ...
    for metric in metrics:
        ...
        for idx, domain in enumerate(['Content', 'Coping', 'Quitting']):
            ...
            # Add value labels on bars VERTICALLY (BOLD and BIGGER for legibility, no overlap)
...
def main():
    ...
    print("   • 7 methods (Zero-shot all/select, Few-shot all/select, Continuous, Digital Twin 70/30)")
